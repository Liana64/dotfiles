...
- `context/AGENTS.md` → `~/.claude/CLAUDE.md` (global directives).
...
| behavioral guidance / recurring correction | directive | `modules/agentic/context/AGENTS.md` |
...
| `eek` | launch claude code against the eek fireworks gateway |
