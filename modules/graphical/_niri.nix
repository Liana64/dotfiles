# @desc: Niri scrollable-tiling compositor
{
  config,
  lib,
  pkgs,
    ...
    programs.niri.settings = {
      ...
      binds =
        ...
        // {
          ...
          "${mod}+Ctrl+Shift+a".action.spawn = taskApp;
